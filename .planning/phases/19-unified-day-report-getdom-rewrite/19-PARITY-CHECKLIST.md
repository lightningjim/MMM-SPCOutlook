...
| 12 | PROXUI-01, PROXUI-02 | Day 1/Day 2 rows: colored risk text + `proximityBadge(categorical, mode)`, mode = `risk=="NONE" ? "outside" : "inside"` | MMM-SPCOutlook.js:541-561 | MMM-SPCOutlook.js:541-546 — the outside-mode half carries forward as D-08's compact-line proximity-only exception (D-08-EXC, intentional-change table). The inside-mode half (a day WITH a surviving hazard) relocates to detail mode, not yet built — plan 19-05 | | | 19-04, D-07-RELOC pending 19-05 |
