...
- [ ] **Phase 14: Foundation & WPC Excessive Rainfall Outlook** - Decouple payload shape from `extended`, establish per-product toggles and endpoint conventions, ship ERO
...
- [ ] 14-03-PLAN.md — ERO backend: products socket contract, fetch/evaluate, excessiveRain block (wave 2)
- [ ] 14-04-PLAN.md — ERO frontend: toggle, render rows, extend the no-risk gate (wave 3)
- [ ] 14-05-PLAN.md — UAT fixtures + human verification of the five success criteria (wave 4)
